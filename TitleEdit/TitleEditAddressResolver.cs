...
namespace TitleEdit
{
    public static class TitleEditAddressResolver
    {
        ...
        public static void Setup64Bit(SigScanner sig)
        {
            ...
            CameraBase = sig.GetStaticAddressFromSig("4C 8D 35 ?? ?? ?? ?? 85 D2");
            ...
            BgmControl = sig.GetStaticAddressFromSig("48 8B 05 ?? ?? ?? ?? 48 85 C0 74 37 83 78 08 04");
            WeatherPtrBase = sig.GetStaticAddressFromSig("48 8B 05 ?? ?? ?? ?? 48 8B D9 0F 29 7C 24 ?? 41 8B FF");
        }
    }
}